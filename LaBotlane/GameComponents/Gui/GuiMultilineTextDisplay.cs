...
namespace Labotlane.GameComponents.Gui
{
    ...
    public class GuiMultilineTextDisplay : GuiWidget
    {
        ...
        public override void Draw(Microsoft.Xna.Framework.Graphics.SpriteBatch batch)
        {
            ...
            var font = LaBotlane.Instance.Ressources.CourrierFont;
            ...
            GameMap.Position pos = Position;
            Rectangle menuBox = new Rectangle((int)pos.ScreenSpace.X, (int)pos.ScreenSpace.Y, Size.X, Size.Y);
            
            // Dessine la boite principale du menu.
            Drawing.DrawRectBox(batch, LaBotlane.Instance.Ressources.TextBox,
                menuBox,
                Color.White,
            ...
            for (int line = lastLine; line >= firstLine; line--)
            {
                ...
                batch.DrawString(font, m_linesCache[line],
                    pos.ScreenSpace + new Vector2(Margins, Margins+y),
                    Color.White,
                    0.0f,
                    Vector2.Zero,
                    1.0f,
                    SpriteEffects.None,
                    Ressources.GUI_DEPTH + 0.02f);
            }
        }
        #endregion
        ...
        public List<string> ComputeLine(string s)
        {
            ...
            {
                Vector2 size = LaBotlane.Instance.Ressources.CourrierFont.MeasureString(buff + word + " ");
