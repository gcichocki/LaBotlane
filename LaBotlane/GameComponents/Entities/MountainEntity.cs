...
namespace Labotlane.GameComponents.Entities
{
    ...
    /// Sol de base.
    /// </summary>
    public class MountainEntity : Entity
    {
        #region Properties
        ...
        public override void OnCrossedBy(Entity entity)
        {
            LaBotlane.Instance.Scene.Map.RemoveEntity(entity);
        }
        #endregion
